...
const Login: React.FunctionComponent = () => {
	...
	return (
		<div className="flex h-screen items-center justify-center bg-[#E5F4EC]">
			...
			<div className="flex h-max flex-row bg-[#FAFAFA]">
				<div className="m-2 flex min-h-screen w-screen flex-col items-start justify-center p-6 md:min-h-full md:w-[500px] md:p-14">
