...
const RegisterForm = ({ formAnimation, handleSetLoginView }) => {
	...
	return (
		...
		>
			<Dialog.Title className="text-xl font-bold text-gray-900">Register your account</Dialog.Title>
			<div>
			...
			<p className="text-gray-600">
				...
				<button onClick={handleSetLoginView} type="button" className="text-red-500 hover:underline">
					Login!
				</button>
			</p>
		</motion.div>
